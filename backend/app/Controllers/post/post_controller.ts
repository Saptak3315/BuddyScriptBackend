...
import { CreatePost, DeletePost, UpdatePost,getLike, showLikers, showComments,getComment } from "./post_validator.js";
...
export default class PostController{
    ...
    public async AllPost({response}:HttpContext){
        const comment=await this.postService.AllPost();
        return response.send(comment)
    }
}